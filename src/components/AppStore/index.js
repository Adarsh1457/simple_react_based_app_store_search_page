...
class AppStore extends Component {
  ...
  changeList = each => {
    this.setState({
      searchValue: each.target.value,
    })
  }
  render() {
    const {activeTab, searchValue} = this.state
    const currentList = appsList.filter(
      each =>
    ...
    return (
      <div className="bg-main">
        ...
        <div className="icon-Search-cont">
          <input type="search" placeholder="Search" onChange={this.changeList} />
          <i>
            <img
